...
const USERS = [
  ...
  },
  {
    id: 2,
    name: "Diego Torres",
    email: "diego@codelco.cl",
    company: "Codelco Norte",
    status: "active",
  ...
  },
  {
    id: 3,
    name: "Ana Soto",
    email: "ana@goldfield.cl",
    company: "Gold Field Chile",
    status: "inactive",
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <SelectField
            ...
            options={[
              ...
              {
                label: "Minera Andina S.A.",
                value: "Minera Andina S.A.",
              },
              {
                label: "Codelco Norte",
                value: "Codelco Norte",
              ...
              {
                label: "Gold Field Chile",
                value: "Gold Field Chile",
              },
              {
                label: "Antofagasta PLC",
                value: "Antofagasta PLC",
              },
              {
                label: "Anglo American Chile",
                value: "Anglo American Chile",
              },
            ]}
          />
          {user && (
...
export function AdminUsersScreen() {
  ...
  return (
    <div>
      ...
      <div
        className="bg-white rounded-xl border p-4 mb-5 flex items-center gap-3"
        style={{ borderColor: colors.border }}
      >
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={6}>
                  <EmptyState title="No se encontraron administradores" />
                </td>
              </tr>
            ) : (
              filtered.map((u, i) => (
